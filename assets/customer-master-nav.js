/* ============================================================
   CHATPHETCH GROUP — MASTER NAVIGATION
   Canonical service menu synchronized with services.html
   ============================================================ */
...
(function(){
  ...
  const NAV = [
    ...
    {label:"ผลงาน",href:"projects.html"},
    {label:"โครงการอ้างอิง",href:"reference.html"},
    {label:"ศูนย์เทคนิค",href:"technical-center.html"},
    {label:"คลังความรู้",href:"knowledge.html"},
    {label:"ติดต่อเรา",href:"contact.html"},
    {label:"🔎 ติดตามคำสั่งซื้อ",href:"order-status.html"},
    {label:"🛒 ตะกร้า",href:"cart.html",cart:true}
  ];
  ...
  const FOOTER = [
    ...
    {label:"เกี่ยวกับเรา",href:"about.html"},
    {label:"สินค้า",href:"products.html"},
    {label:"บริการ",href:"services.html"},
    {label:"ผลงาน",href:"projects.html"},
    {label:"ติดต่อเรา",href:"contact.html"}
  ];
  ...
  const css = `
    ...
    .customer-nav-dropdown{
      ...
      box-shadow:0 24px 65px rgba(0,0,0,.72);
      opacity:0;
      visibility:hidden;
    ...
    .customer-nav-item.has-dropdown:hover .customer-nav-dropdown,
    .customer-nav-item.dropdown-open .customer-nav-dropdown{
      opacity:1;
      visibility:visible;
      transform:none;
    }
    ...
    .customer-nav-dropdown a:hover{
      color:#ead18d;
      background:rgba(201,164,92,.075);
      padding-left:23px;
    }
    ...
    @media(max-width:1050px){
      ...
      .customer-nav-item.has-dropdown.dropdown-open .customer-nav-dropdown{
        display:block;
      }
      ...
      body.customer-menu-open .customer-mobile-backdrop{
        display:block;
      }
  ...
  function injectStyles(){
    if(document.getElementById("chatpetch-master-nav-style")) return;

    const style=document.createElement("style");
    style.id="chatpetch-master-nav-style";
  ...
  function cartCount(){
    try{
      ...
      return Array.isArray(cart)
        ? cart.reduce(
            (n,item)=>n+Number(item.quantity ?? item.qty ?? 1),
            0
          )
        : 0;
  ...
  function buildNavItem(item){
    ...
    if(item.dropdown){
      ...
      button.type="button";
      button.className="customer-nav-trigger";

      button.innerHTML=`
        ${item.label}
        <span class="customer-nav-arrow">▼</span>
      `;
      ...
      button.addEventListener("click",e=>{
        ...
        document
          .querySelectorAll(".customer-nav-item.dropdown-open")
          .forEach(x=>{
            if(x!==li){
              x.classList.remove("dropdown-open");
            }
          });
      ...
      box.className="customer-nav-dropdown";
      ...
      if(item.cart){
        ...
        badge.className="customer-cart-count";
  ...
  function buildHeader(){
    ...
    if(document.querySelector(".customer-header")){
      return;
    }
    ...
    navbar.className="customer-navbar";

    const wrap=document.createElement("div");

    wrap.className="customer-nav-container";
    ...
    list.className="customer-nav-list";

    NAV.forEach(item=>{
      list.appendChild(buildNavItem(item));
    });
    ...
    toggle.innerHTML=`
      <span class="customer-menu-toggle-inner">
        <span></span>
        <span></span>
        <span></span>
      </span>
    ...
    backdrop.className="customer-mobile-backdrop";
  ...
  function buildFooter(){
    ...
    if(document.querySelector(".customer-footer")){
      return;
    }
